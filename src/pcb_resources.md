...
- Once you somewhat have a grasp on what your assigned/given board does, make a presentation on it (individually or with a partner)! Run through all parts of the schematic and explain its functions
    ...
    - Once you have an idea of how the board works, make sure to read ALL of the rules related to how that system
...
- Now that you’re confident on how your board works, it’s time to run through possible improvements. Make a presentation on ways you can possibly improve the given board
